...
export type OpenCodeModelProviderConnection = typeof OpenCodeModelProviderConnection.Type;

export const OpenCodeListModelProvidersInput = Schema.Struct({
  cwd: Schema.optional(TrimmedNonEmptyString),
  forceReload: Schema.optional(Schema.Boolean),
});
export type OpenCodeListModelProvidersInput = typeof OpenCodeListModelProvidersInput.Type;

export const OpenCodeListModelProvidersResult = Schema.Struct({
  providers: Schema.Array(OpenCodeModelProviderConnection),
  configuredProviderCount: Schema.Number,
  modelCount: Schema.Number,
  source: Schema.optional(TrimmedNonEmptyString),
  cached: Schema.optional(Schema.Boolean),
});
export type OpenCodeListModelProvidersResult = typeof OpenCodeListModelProvidersResult.Type;

export const OpenCodeSetApiKeyInput = Schema.Struct({
  providerId: TrimmedNonEmptyString,
  apiKey: TrimmedNonEmptyString.check(Schema.isMaxLength(16_384)),
  cwd: Schema.optional(TrimmedNonEmptyString),
});
export type OpenCodeSetApiKeyInput = typeof OpenCodeSetApiKeyInput.Type;

export const OpenCodeRemoveCredentialInput = Schema.Struct({
  providerId: TrimmedNonEmptyString,
  cwd: Schema.optional(TrimmedNonEmptyString),
});
export type OpenCodeRemoveCredentialInput = typeof OpenCodeRemoveCredentialInput.Type;

export const OpenCodeCredentialMutationResult = Schema.Struct({
  providerId: TrimmedNonEmptyString,
  connected: Schema.Boolean,
});
export type OpenCodeCredentialMutationResult = typeof OpenCodeCredentialMutationResult.Type;
...
export const ProviderModelModality = Schema.Literals(["text", "audio", "image", "video", "pdf"]);
export type ProviderModelModality = typeof ProviderModelModality.Type;

export const ProviderModelProcessingLocality = Schema.Literals(["local", "remote", "unknown"]);
export type ProviderModelProcessingLocality = typeof ProviderModelProcessingLocality.Type;
...
export const ProviderModelDescriptor = Schema.Struct({
  ...
  outputModalities: Schema.optional(Schema.Array(ProviderModelModality)),
  supportsVision: Schema.optional(Schema.Boolean),
  supportsPdf: Schema.optional(Schema.Boolean),
  supportsAttachments: Schema.optional(Schema.Boolean),
  supportsToolCalls: Schema.optional(Schema.Boolean),
  contextLimitTokens: Schema.optional(Schema.Int.check(Schema.isGreaterThan(0))),
  processingLocality: Schema.optional(ProviderModelProcessingLocality),
});
