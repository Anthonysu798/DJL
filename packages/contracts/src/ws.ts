...
export const WS_METHODS = {
  ...
  // DJL Work document intelligence (server-owned configuration only)
  workDocumentIntelligenceStatus: "work.documentIntelligence.status",
  workDocumentIntelligenceInstall: "work.documentIntelligence.install",
  workDocumentIntelligenceRepair: "work.documentIntelligence.repair",
  workDocumentIntelligenceUninstall: "work.documentIntelligence.uninstall",
  workListPreparedDocuments: "work.documents.listPrepared",
  workPreviewDocument: "work.documents.preview",
  workResolveArtifactPath: "work.artifacts.resolvePath",
  workDocumentRendererStatus: "work.documentRenderer.status",
  workDocumentRendererInstall: "work.documentRenderer.install",
  workDocumentRendererRepair: "work.documentRenderer.repair",
  workDocumentRendererUninstall: "work.documentRenderer.uninstall",
  workRequestDocumentRender: "work.documents.requestRender",
  workGetDocumentRender: "work.documents.getRender",
  workCancelDocumentRender: "work.documents.cancelRender",
  subscribeWorkDocumentRenderEvents: "work.documentRenderEvent",
  ...
  openCodeListModelProviders: "opencode.listModelProviders",
  openCodeSetApiKey: "opencode.setApiKey",
  openCodeRemoveCredential: "opencode.removeCredential",

  // Desktop local-model runtimes
  localModelsGetSnapshot: "localModels.getSnapshot",
  localModelsRefresh: "localModels.refresh",
  localModelsInstallRuntime: "localModels.installRuntime",
  localModelsStartRuntime: "localModels.startRuntime",
  localModelsInstallModel: "localModels.installModel",
  localModelsCancelInstall: "localModels.cancelInstall",
  ...
  aiDetectorInstallModel: "aiDetector.installModel",
  aiDetectorCancelInstall: "aiDetector.cancelInstall",
  aiDetectorRemoveModel: "aiDetector.removeModel",
...
export const WS_CHANNELS = {
  ...
  workDocumentRenderEvent: "work.documentRenderEvent",
  localModelEvent: "localModels.event",
  aiDetectorEvent: "aiDetector.event",
...
const WebSocketRequestBody = Schema.Union([
  ...
  // DJL Work
  tagRequestBody(WS_METHODS.workDocumentIntelligenceStatus, Schema.Struct({})),
  tagRequestBody(WS_METHODS.workDocumentIntelligenceInstall, Schema.Struct({})),
  tagRequestBody(WS_METHODS.workDocumentIntelligenceRepair, Schema.Struct({})),
  tagRequestBody(WS_METHODS.workDocumentIntelligenceUninstall, Schema.Struct({})),
  tagRequestBody(WS_METHODS.workListPreparedDocuments, WorkListPreparedDocumentsInput),
  tagRequestBody(WS_METHODS.workPreviewDocument, WorkPreviewDocumentInput),
  tagRequestBody(WS_METHODS.workResolveArtifactPath, WorkResolveArtifactPathInput),
  tagRequestBody(WS_METHODS.workDocumentRendererStatus, Schema.Struct({})),
  tagRequestBody(WS_METHODS.workDocumentRendererInstall, Schema.Struct({})),
  tagRequestBody(WS_METHODS.workDocumentRendererRepair, Schema.Struct({})),
  tagRequestBody(WS_METHODS.workDocumentRendererUninstall, Schema.Struct({})),
  tagRequestBody(WS_METHODS.workRequestDocumentRender, WorkRequestDocumentRenderInput),
  tagRequestBody(WS_METHODS.workGetDocumentRender, WorkGetDocumentRenderInput),
  tagRequestBody(WS_METHODS.workCancelDocumentRender, WorkCancelDocumentRenderInput),
  tagRequestBody(WS_METHODS.subscribeWorkDocumentRenderEvents, Schema.Struct({})),
  ...
  tagRequestBody(WS_METHODS.cloudGetStatus, CloudEmptyInput),
  ...
  // Desktop local-model runtimes
  tagRequestBody(WS_METHODS.localModelsGetSnapshot, Schema.Struct({})),
  tagRequestBody(WS_METHODS.localModelsRefresh, Schema.Struct({})),
  tagRequestBody(WS_METHODS.localModelsInstallRuntime, LocalModelRuntimeInput),
  tagRequestBody(WS_METHODS.localModelsStartRuntime, LocalModelRuntimeInput),
  tagRequestBody(WS_METHODS.localModelsInstallModel, OllamaLocalModelInstallInput),
  tagRequestBody(WS_METHODS.localModelsInstallModel, LmStudioLocalModelInstallInput),
  tagRequestBody(WS_METHODS.localModelsCancelInstall, LocalModelCancelInstallInput),
  ...
  tagRequestBody(WS_METHODS.aiDetectorInstallModel, AiDetectorInstallModelInput),
  tagRequestBody(WS_METHODS.aiDetectorCancelInstall, AiDetectorCancelInstallInput),
...
export interface WsPushPayloadByChannel {
  ...
  readonly [WS_CHANNELS.workDocumentRenderEvent]: typeof DocumentRenderEvent.Type;
  readonly [WS_CHANNELS.localModelEvent]: typeof LocalModelEvent.Type;
  readonly [WS_CHANNELS.aiDetectorEvent]: typeof AiDetectorEvent.Type;
...
export const WsPushWorkDocumentRenderEvent = makeWsPushSchema(
  WS_CHANNELS.workDocumentRenderEvent,
  DocumentRenderEvent,
);
export const WsPushLocalModelEvent = makeWsPushSchema(WS_CHANNELS.localModelEvent, LocalModelEvent);
export const WsPushAiDetectorEvent = makeWsPushSchema(WS_CHANNELS.aiDetectorEvent, AiDetectorEvent);
...
export const WsPushChannelSchema = Schema.Literals([
  ...
  WS_CHANNELS.projectDevServerEvent,
  WS_CHANNELS.workDocumentRenderEvent,
  WS_CHANNELS.localModelEvent,
  WS_CHANNELS.aiDetectorEvent,
  ORCHESTRATION_WS_CHANNELS.domainEvent,
  ORCHESTRATION_WS_CHANNELS.shellEvent,
  ORCHESTRATION_WS_CHANNELS.threadEvent,
]);
...
export const WsPush = Schema.Union([
  ...
  WsPushWorkDocumentRenderEvent,
  WsPushLocalModelEvent,
  WsPushAiDetectorEvent,
