...
export const WorkCapabilityFlags = Schema.Struct({
  releaseStage: NonNegativeInt.check(Schema.isLessThanOrEqualTo(5)),
  workCore: Schema.Boolean,
  documentPreparation: Schema.Boolean,
  localDocumentIntelligence: Schema.Boolean,
  projectMemory: Schema.Boolean,
  productionHardening: Schema.Boolean,
  cloudDocumentIntelligence: Schema.Boolean,
});
...
export const ServerConfig = Schema.Struct({
  ...
  workCapabilities: Schema.optionalKey(WorkCapabilityFlags),
});
