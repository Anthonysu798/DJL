...
export interface ThreadEnvironmentPresentation {
  ...
  worktreeOptionLabel: string;
  worktreeBadgeLabel: string | null;
}
...
export function resolveThreadEnvironmentPresentation(input: {
  ...
  return {
    ...
    shortLabel:
      mode === "worktree"
        ? translateRendererCopy("chat:environmentCopy.worktree", "Worktree")
        : translateRendererCopy("chat:environmentCopy.local", "Local"),
    localOptionLabel: translateRendererCopy("chat:environmentCopy.localProject", "Local project"),
    worktreeOptionLabel: translateRendererCopy("chat:environmentCopy.worktree", "Worktree"),
    worktreeBadgeLabel:
      workspaceState === "worktree-ready"
        ? translateRendererCopy("chat:environmentCopy.worktree", "Worktree")
        : workspaceState === "worktree-pending"
          ? translateRendererCopy("chat:environmentCopy.worktreePending", "Worktree pending")
          : null,
  };
}
  ...
  return {
    ...
    disabledReason: pending
      ? translateRendererCopy(
          "chat:environmentCopy.diffPending",
