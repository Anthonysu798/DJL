...
export function resolveFirstSendTarget(input: {
  ...
  // A Work task remains a Work task regardless of where it is authorized to
  // operate. The selected folder is carried by the thread environment; moving
  // the draft into a developer project here would drop the Work lifecycle,
  // preparation queue, scoped tools, and project memory.
