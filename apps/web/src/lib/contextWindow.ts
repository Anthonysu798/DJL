...
export function deriveContextWindowMeterDisplay(
  ...
  return {
    ...
    ariaLabel: usedPercentageLabel
      ? translateRendererCopy("common:hardening.contextPercent", "Context window {{usage}} used", {
          usage: usedPercentageLabel,
        })
      : translateRendererCopy(
          "common:hardening.contextTokens",
          "Context window {{usage}} tokens used",
          { usage: tokenUsageLabel },
        ),
  };
}
