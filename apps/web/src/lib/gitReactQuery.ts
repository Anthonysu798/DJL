...
export function gitStageFilesMutationOptions(input: {
  ...
  return makeGitMutationOptions<readonly string[], { ok: boolean }>({
    ...
    unavailableMessage: translateRendererCopy(
      "workspace:git.disabled.staging",
...
export function gitUnstageFilesMutationOptions(input: {
  ...
  return makeGitMutationOptions<readonly string[], { ok: boolean }>({
    ...
    unavailableMessage: translateRendererCopy(
      "workspace:git.disabled.unstaging",
      "Unstaging is unavailable.",
    ),
    invalidate: "cwd",
    run: (api, cwd, paths) => {
...
export function gitPreparePullRequestThreadMutationOptions(input: {
  ...
  >({
    ...
    unavailableMessage: translateRendererCopy(
      "workspace:git.disabled.prPreparation",
      "Pull request thread preparation is unavailable.",
    ),
