...
describe("resolveThreadStatusPill", () => {
  ...
  it("resolves semantic status keys from the active runtime catalog", async () => {
    await rendererI18n.init({
      fallbackLng: "en",
      lng: "fr",
    ...
    ).toMatchObject({ label: frenchCatalog.shell.sidebar.status.pendingApproval });
