...
function SkillGridItem({ skill }: { skill: ProviderSkillDescriptor }) {
  ...
  const description =
    skill.interface?.shortDescription ?? skill.description ?? t("pluginLibrary.noDescription");
      ...
      <div className="flex h-full flex-col">
        ...
        >
          ...
          <div className="flex items-end gap-3">
            <TabButton
              label={t("pluginLibrary.plugins")}
              active={selectedTab === "plugins"}
              onClick={() => setSelectedTab("plugins")}
            />
            <TabButton
              label={t("pluginLibrary.skills")}
        ...
        <div className="min-h-0 flex-1 overflow-y-auto">
          ...
          <div className="px-6 py-10 text-center">
            <h1 className="text-[28px] font-semibold text-foreground">
              {t("pluginLibrary.hero", { provider: providerLabel })}
            </h1>
          </div>
          ...
          <div className="mx-auto max-w-2xl px-6 pb-6">
            <InputGroup className="rounded-xl bg-background/70 shadow-xs">
              ...
              <InputGroupInput
                ...
                placeholder={
                  selectedTab === "plugins"
                    ? t("pluginLibrary.searchPlugins")
                    : t("pluginLibrary.searchSkills")
                }
                className="text-sm"
              />
            </InputGroup>
          ...
          {((!discoveryCwd && selectedTab === "skills") ||
            ...
            <div className="mx-auto max-w-2xl space-y-1.5 px-6 pb-4">
              {!discoveryCwd && selectedTab === "skills" ? (
                <InlineWarning>{t("pluginLibrary.workspaceRequired")}</InlineWarning>
              ) : null}
              {selectedTab === "plugins" && pluginsQuery.data?.remoteSyncError ? (
            ...
            {selectedTab === "plugins" ? (
              <>
                {!canListPlugins ? (
                  <div className="mx-auto max-w-2xl">
                    <EmptyPanel
                      title={t("pluginLibrary.pluginsUnavailable", { provider: providerLabel })}
                      description={t("pluginLibrary.pluginDiscoveryUnavailable")}
                    />
                  </div>
                  ...
                  <EmptyPanel
                    title={t("pluginLibrary.noInstalledPlugins")}
                    description={t("pluginLibrary.installedPluginsOnly")}
                  />
                ) : (
              ...
              <>
                {!canListSkills ? (
                  <div className="mx-auto max-w-2xl">
                    <EmptyPanel
                      title={t("pluginLibrary.skillsUnavailable", { provider: providerLabel })}
                      description={t("pluginLibrary.skillDiscoveryUnavailable")}
                    />
                  </div>
                  ...
                  <EmptyPanel
                    title={t("pluginLibrary.noSkills")}
                    description={t("pluginLibrary.noSkillsMatch")}
                  />
                ) : (
                  <div>
                    <SectionHeader title={t("pluginLibrary.skills")} />
                    <div className="grid grid-cols-1 sm:grid-cols-2">
