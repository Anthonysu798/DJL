...
describe("RateLimitsPanel helpers", () => {
  it("formats reset dates with the selected application locale", () => {
    expect(formatRateLimitResetTime("2099-04-15T12:00:00.000Z", "en")).toBe("Apr 15");
    expect(formatRateLimitResetTime("2099-04-15T12:00:00.000Z", "fr")).toBe("15 avr.");
  });
