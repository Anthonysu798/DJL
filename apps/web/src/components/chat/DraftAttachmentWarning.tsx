...
export const DRAFT_ATTACHMENT_WARNING_LABEL_KEY = "attachments.draftWarningLabel";
/** Explanatory copy shown in the hover tooltip / detail row. */
export const DRAFT_ATTACHMENT_WARNING_DESCRIPTION_KEY = "attachments.draftWarningDescription";
