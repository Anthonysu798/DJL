      ...
      <ComposerStackedPanelHeaderRow>
        <ComposerStackedPanelRowMain>
          ...
          <ComposerStackedPanelRowLabel tone="meta">
            {t("tasks.progress", { completed: completedCount, total: totalCount })}
          </ComposerStackedPanelRowLabel>
        </ComposerStackedPanelRowMain>
        <div className="flex shrink-0 items-center gap-0.5">
          <Button
            ...
            aria-label={t("tasks.openSidebar")}
            title={t("tasks.openSidebar")}
          >
          ...
          <Button
            ...
            aria-label={compact ? t("tasks.expand") : t("tasks.collapse")}
            title={compact ? t("tasks.expand") : t("tasks.collapse")}
          >
            {compact ? (
            ...
            >
              <div className="flex min-w-0 items-center gap-1.5">
                ...
                <span className="truncate">
                  {t("tasks.backgroundAgentCount", { count: backgroundTaskCount })}
                </span>
              </div>
            </div>
          ) : null}
