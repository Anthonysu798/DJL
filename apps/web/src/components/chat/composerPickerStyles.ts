...
/** Gives model catalogs enough inline space for full model names without widening other pickers. */
export const COMPOSER_PICKER_MODEL_MENU_WIDTH_CLASS_NAME = "composer-picker-menu-model";
