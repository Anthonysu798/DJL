...
export function EnvironmentProjectInstructionsSection({
  ...
  const copyLabel = t(
    threadNotes.trim().length === 0
      ? "environment.projectInstructions.copy"
      : "environment.projectInstructions.append",
  );

  return (
    <EnvironmentCollapsibleSection
      label={t("environment.projectInstructions.title")}
    ...
    >
      <div className="flex flex-col gap-2 px-2 pb-1">
        <Textarea
          ...
          placeholder={t("environment.projectInstructions.placeholder")}
