...
export function EnvironmentMarkersSection({
  ...
  return (
    <EnvironmentCollapsibleSection label={t("environment.markers.title")}>
  ...
  return (
    <li className="group/marker flex items-center gap-1.5 rounded-lg px-2 py-1 hover:bg-[var(--color-background-elevated-secondary)]">
      <Checkbox
        ...
        aria-label={
          marker.done ? t("environment.items.markNotDone") : t("environment.items.markDone")
        }
      />
      <span
        aria-hidden="true"
      ...
      {editing ? (
        ...
        <button
          ...
          aria-label={
            available ? t("environment.markers.jumpAria") : t("environment.markers.unavailableAria")
          }
          title={
            available ? t("environment.markers.jumpHint") : t("environment.markers.unavailableHint")
          }
          className={cn(
      ...
      <IconButton
        label={t("environment.markers.remove")}
