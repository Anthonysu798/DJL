    ...
    <Sheet open={props.open} onOpenChange={props.onOpenChange}>
      <SheetPopup side="right" className="w-[min(92vw,420px)] max-w-[420px]" keepMounted>
        <SheetHeader>
          ...
          <SheetDescription>
            {t("settings.description", { workspace: props.workspaceTitle })}
          </SheetDescription>
        </SheetHeader>
