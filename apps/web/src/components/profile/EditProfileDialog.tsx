...
export function EditProfileDialog({
  ...
  const handlePickFile = async (file: File | undefined) => {
    ...
    try {
      ...
      const detail =
        cause instanceof AvatarImageError ? t(`profileAvatarErrors.${cause.code}`) : null;
      setError(
        detail ? t("profile.edit.imageErrorWithDetail", { detail }) : t("profile.edit.imageError"),
      );
    } finally {
      setProcessing(false);
    }
          ...
          <div className="flex flex-col items-center gap-3">
            <div className="relative">
              ...
              <button
                ...
                aria-label={t("profile.edit.avatarAriaLabel")}
                className={cn(
