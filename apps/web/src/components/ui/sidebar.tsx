        ...
        <Sheet onOpenChange={setOpenMobile} open={openMobile} {...props}>
          ...
          >
            <SheetHeader className="sr-only">
              <SheetTitle>{t("navigation.mobileSidebar")}</SheetTitle>
              <SheetDescription>{t("navigation.mobileSidebarDescription")}</SheetDescription>
            </SheetHeader>
...
function SidebarRail({
  ...
  const railLabel = canResize ? t("navigation.resizeSidebar") : t("navigation.toggleSidebar");
  const railTitle = canResize
    ? t("navigation.resizeSidebarDescription")
