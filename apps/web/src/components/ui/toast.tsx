    ...
    <div className="mt-2 flex flex-wrap items-center gap-1.5">
      {copyText && (
        <Button
          aria-label={
            isCopied
              ? t("toast.copiedError", { ns: "notifications" })
              : t("toast.copyError", { ns: "notifications" })
          }
        ...
        >
          ...
          <span>
            {isCopied
              ? t("toast.copied", { ns: "notifications" })
    ...
    <>
      ...
      >
        ...
        >
          ...
          >
            {t("toast.undo", { ns: "notifications" })}
          </button>{" "}
          {t("toast.archivedIn", { ns: "notifications" })}{" "}
          <button
            type="button"
            className={ARCHIVE_UNDO_TOAST_LINK_CLASS_NAME}
            data-base-ui-swipe-ignore
