...
//   - Current-release dates use ISO `YYYY-MM-DD` so the UI can localize them.
//     Historical authored labels remain verbatim.
...
export const WHATS_NEW_ENTRIES: readonly WhatsNewEntry[] = [
    ...
    features: [
      {
        ...
        details:
          "The desktop bundle is now com.emanueledipietro.synara, the CLI is @synara/cli with the synara command, and every first-party runtime identifier uses the DJL namespace. The 0.4.2 bridge preserves renderer state during the origin change.",
      },
      {
    ...
    features: [
      {
        ...
        title: "DJL is preparing a seamless identity upgrade",
        description:
          "Launch this version at least once before installing the next DJL release so your drafts, pins, theme, browser state, and other local interface preferences move with you.",
        details:
          "This bridge writes a validated DJL-only snapshot of renderer state, keeps existing project and thread data intact, and prepares database and checkpoint metadata for the final identity cutover. Earlier command and environment aliases are accepted by this bridge release only and will be removed next.",
      },
      {
      ...
      },
      {
        ...
        description:
          "DJL checks that an update actually installed after restart, detects failed installs, and recovers instead of silently staying on the old version.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "DJL is more careful about restoring the right destination after reloads, segment switches, reconnects, and partially completed project creation.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "When Claude reports usage or rate-limit trouble, DJL now presents the condition more calmly instead of turning it into a generic provider failure.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "DJL is better at shutting down stubborn terminal process trees without returning early while child processes are still alive.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "When a worktree setup step fails, DJL now shows the failed setup state, keeps the timeline from looking stuck, and resets the local dispatch when you send again.",
        details:
      ...
      },
      {
        ...
        description:
          "DJL avoids unnecessary provider refresh work during startup and gates Claude keepalive behavior more carefully, so opening the app is calmer and less likely to fight credential checks.",
        details:
    ...
    features: [
      {
        ...
        description:
          "When DJL is downloading a desktop update, the sidebar update button now shows a live percent badge so you can tell whether it is moving or nearly ready.",
        details:
      ...
      },
      {
        ...
        description:
          "DJL preserves the first pre-turn snapshot more carefully, so transcript diffs and restore points better match what was on disk when you pressed send.",
        details:
    ...
    features: [
      {
        ...
        description:
          "DJL now finds Cursor agent commands across more install layouts, including bundled sibling shims and legacy shim locations, while rejecting unsafe fallbacks.",
        details:
      ...
      },
      {
        ...
        description:
          "DJL refreshes Claude credential freshness on macOS so long sessions are less likely to hit the familiar stale-token sign-in failure.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "DJL now reuses the central robot glyph for agent chips, improves file-change and tool-call labels, refines chat card contrast, and tightens shared switch sizing, thumb travel, and animation.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "DJL can now launch VS Code Store installs through the right Windows app identity and URI fallback, so editor buttons work even when the normal `code` command is unavailable.",
        details:
      ...
      },
      {
        ...
        description:
          "A new settings toggle lets you disable provider update checks when you want DJL to stay quieter about external CLI versions.",
        details:
      ...
      },
      {
        ...
        title: "The app icon and DJL mark look cleaner",
        description:
          "The desktop, web, marketing, and release assets were refreshed so the DJL icon renders more consistently across macOS, Windows, browser favicons, and update artifacts.",
        details:
          "This release refreshes the inline DJL logo path, replaces generated icon assets from the full source image, corrects macOS bundle icon handling after the rounded-icon Ventura pass, and removes a literal Dock-icon workaround that was not the final direction.",
      },
      {
      ...
      },
      {
        ...
        description:
          "DJL polls local server state less aggressively while idle, reducing background work without changing the active-session refresh path.",
        details:
    ...
    features: [
      {
        ...
        description:
          "The branch toolbar can now show and change the active project, so project, branch, and worktree context are easier to keep aligned while you move around DJL.",
        details:
      ...
      },
      {
        ...
        details:
          "DJL now builds file diff trees, renders a collapsible review panel with shared disclosure motion, and reuses file-row styling so review navigation feels closer to the rest of the workspace.",
      },
      {
    ...
    features: [
      {
        ...
        details:
          "DJL now formats tool command transcripts, normalizes patch/change output, labels more tool kinds consistently, preserves structured work metadata through the timeline, and adds focused coverage for tool-call labels and formatting.",
      },
      {
        id: "transcript-flow",
      ...
      },
      {
        ...
        details:
          "DJL now ships a curated central-icons set, improves provider/model picker presentation, refines composer picker and automation banners, adds better project/thread hover details, and keeps repeated UI surfaces closer to the same visual language.",
      },
    ],
  },
  {
    ...
    features: [
      {
        ...
        description:
          "DJL now has first-class Automations for scheduled agent work, with sidebar navigation, list/detail pages, run history, triage actions, and inline editing.",
        details:
      ...
      },
      {
        ...
        details:
          "File attachments now flow through contracts, upload storage, composer paste/drop, provider prompts, Kanban dispatch, recap/bootstrap surfaces, optimistic timeline rendering, caps/rollback, attachment-bearing plan follow-ups, explicit unsupported-file rejection, worktree-backed file preview roots, and blob-based download handling that keeps failed local image downloads inside DJL.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "DJL now waits for one fresh server snapshot before giving up on a remembered chat route, so app restarts are less likely to dump you onto an empty fallback screen.",
        details:
    ...
    features: [
      {
        ...
        description:
          "DJL now tracks richer local profile stats, including your most worked project, skill and agent usage, active hours, provider/model mix, and prompt activity.",
        details:
          "Profile stats now derive more signal from DJL's local projection database: most-worked project, prompt/thread activity, skill and agent usage, provider/model usage, reasoning patterns, active-hour windows, and token heatmap data are all represented in the profile contract and settings panel.",
      },
      {
    ...
    features: [
      {
        ...
        title: "Your DJL profile has more personality",
        description:
          "Profile settings now include richer identity details, activity stats, and a cleaner editing flow so DJL feels more like your own workspace.",
        details:
      ...
      },
      {
        ...
        details:
          "DJL now tracks thread retention state explicitly, covers soft-delete cleanup behavior with server tests, and keeps deletion/recovery semantics more predictable for early WIP data.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "After provider restarts, reconnects, or quiet ACP sessions, DJL does a better job of reconciling active turns and finishing idle work instead of getting stuck.",
        details:
    ...
    features: [
      {
        ...
        title: "PDFs open safely inside DJL",
        description:
      ...
      },
      {
        ...
        details:
          "DJL now routes file preview through `WorkspaceFilePreview`, `PdfFilePreview`, shared preview headers, markdown/source selection references, workspace file openers, dock pane activation metadata, local preview URL helpers, and tighter file reference context-menu behavior.",
      },
      {
        id: "pi-plugin-routing",
        title: "Pi plugin sessions start in the right place",
        description:
          "Pi-backed plugin flows now route through DJL more reliably, discover model support better, and keep startup prompts attached to the correct provider session.",
        details:
      ...
      },
      {
        ...
        details:
          "DJL now preserves Cursor message identity more reliably, removes the older turn diff tree path, refines changed-file file-list rendering, fixes duplicate plan-mode icons and stale plan sidebar state, and hides inline project actions from the chat header where they created noise.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "There is now a playful soccer-ball physics view for experimenting with motion and interaction inside DJL.",
        details:
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "DJL now discovers native editor apps and icons, caches icon assets server-side, exposes authenticated icon routes, and tightens macOS/Linux/Windows launcher handling, including Ghostty working-directory behavior and Linux desktop-entry matching.",
      },
      {
        id: "portable-skills",
      ...
      },
      {
        ...
        details:
          "DJL now reconciles legacy migration bookkeeping before running migrations, expands migration coverage, validates workspace real-path containment, and carries terminal environment updates through shared server and web contracts.",
      },
    ],
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "DJL now reads provider credentials and usage data through shared server parsers, normalizes snapshots, stores cached values in SQLite, and renders reusable usage rows, progress tracks, line lists, and settings panels in the web app.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "DJL now caches site favicons server-side, serves authenticated favicon image URLs, recognizes bare domains in composer text, and keeps markdown link text aligned with the same medium-weight chip styling used while composing.",
      },
      {
    ...
    features: [
      {
        ...
        details:
          "Release tooling now validates Mac update artifacts, parses boolean environment flags consistently, and tests the resumable update downloader without the older update-feed cache layer. The README and release docs were refreshed around the current DJL desktop flow too.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        details:
          "Claude SIGTERM from outside DJL is treated as a benign suspend path, terminal process cleanup has stronger tests, and websocket RPC failure handling is less likely to leave the UI believing a request is still in flight.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "DJL can now generate and cache thread recaps, show current-state context in the chat environment, and reuse provider-backed recap generation without making the transcript harder to follow.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "When Claude reports a missing conversation id, DJL clears the stale resume cursor, recreates the provider session, and retries with transcript context instead of leaving the turn failed.",
      },
      {
        id: "desktop-update-manual-fallback",
        title: "Desktop updates now have a manual escape hatch",
        description:
          "If an in-app install silently fails, DJL restarts the backend, resumes update polling, deduplicates error toasts, and points you at the exact GitHub release page for a manual download.",
      },
      {
      ...
      },
      {
        ...
        description:
          "OpenCode task child sessions and newer shell-step events now flow into DJL's activity timeline, while generic agent task rows keep their useful prompt and result text instead of disappearing or showing wrapper noise.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "OpenCode startup, model discovery, command discovery, server connection options, and experimental WebSocket mode now flow through the same settings and runtime paths as the rest of DJL.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Fresh repair migrations reconcile older imported migration trackers that skipped DJL's sidechat-source or pinned-thread columns, preventing startup crashes in those upgraded histories.",
      },
      {
    ...
    features: [
      {
        ...
        title: "DJL is now the default home",
        description:
          "The app now starts from `~/.synara`, carries the DJL environment variables through the desktop and server runtime, and safely imports data from previous installations on first launch.",
      },
      {
    ...
    features: [
      {
        ...
        description: "DJL now includes Claude Opus 4.8 in the Claude model picker.",
      },
    ],
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "The provider picker no longer treats unknown provider status as usable. Providers stay in a checking state until DJL has confirmed that the local runtime is available and authenticated.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "DJL can now launch and monitor Kilo Code sessions alongside Codex, Claude, Cursor, OpenCode, and Gemini, with health checks, settings, mentions, handoff, and model compatibility wired through the app.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "DJL now tracks the newer OpenCode SDK session events, keeps titles fresher, and has much deeper coverage around OpenCode startup, output, and recovery flows.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "DJL now serves generated files through a dedicated local-image endpoint with MIME checks, workspace-aware path resolution, and Codex generated_images allowlists for both the normal home and desktop overlay home.",
      },
      {
  ...
  },
  {
    ...
    features: [
      {
        id: "cursor-provider",
        title: "Cursor is now a first-class DJL provider",
        description:
          "Run Cursor CLI sessions directly from DJL with ACP-backed startup, model discovery, existing-chat resume, handoff, and provider health checks alongside Codex and OpenCode.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "The Git actions menu can now commit current work and push it from DJL, keeping the common release and handoff flow closer to the chat.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "The Git menu now includes branch creation with DJL-style names, and PR creation can recover from GitHub duplicate-PR responses by reusing the existing open pull request.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "OpenCode todo events now flow into DJL as active task updates, with a compact banner option for keeping current work visible without taking over the chat.",
      },
      {
      ...
      },
      {
        ...
        description:
          "OpenCode sessions now report context usage more consistently, giving DJL better runtime visibility as conversations grow.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "Cursor is now available as a provider, with ACP sessions, model discovery, existing chats, handoff, shortcuts, and git text generation wired into DJL.",
      },
      {
      ...
      },
      {
        ...
        description:
          "Toast notifications picked up feature-flag wiring, giving DJL a safer way to roll notification changes forward or back.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "DJL now handles messy branch switches with clearer recovery actions, recreated stashes, unpublished branch publishing, and stronger checks around conflicts and local work.",
      },
      {
      ...
      },
      {
        ...
        description:
          "The desktop app now has app-level back and forward navigation controls, making it easier to move around DJL without losing your place.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "GPT-5.5 is now in the model picker with the right default reasoning behavior, so you can move new Codex sessions onto the latest model directly from DJL.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "DJL now shows a proper splash screen while the desktop backend spins up, so launch feels intentional instead of looking briefly stalled.",
      },
      {
    ...
    features: [
      {
        ...
        description:
          "The new theme pack editor lets you tune UI colors directly in DJL, with shared theme tokens keeping the sidebar, composer, transcript, and controls in sync.",
      },
      {
  ...
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "If the updater never answers, DJL now times out and recovers instead of hanging on a permanent Checking status.",
      },
    ],
  },
  {
    ...
    features: [
      ...
      },
      {
        ...
        description:
          "Point DJL at your own Codex, Claude, or Gemini binary when your setup lives outside the default install path.",
      },
      {
