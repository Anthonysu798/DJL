...
function printUsage() {
  console.log(
    [
      "Usage:",
      "  djl-jsonl-diagnose /path/to/session.jsonl",
      "",
      "Options:",
...
function toWireTurn(turn) {
  return {
    ...
    items: turn.items.map((item) => ({
      ...
      djlDiagnosticRawBytes: item.rawBytes,
      djlDiagnosticTextBytes: item.textBytes,
    })),
  };
}
