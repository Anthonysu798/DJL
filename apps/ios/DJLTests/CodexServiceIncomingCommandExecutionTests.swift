...
final class CodexServiceIncomingCommandExecutionTests: XCTestCase {
    ...
    func testHistoryDecodesInputImageContentAsAttachment() {
                            ...
                            .object([
                                ...
                                "content": .array([
                                    ...
                                    .object([
                                        ...
                                        "image_url": .object([
                                            "url": .string("djl://history-image-elided"),
                                        ]),
                                    ]),
                                ]),
                            ]),
        ...
        XCTAssertEqual(history[0].attachments[0].sourceURL, "djl://history-image-elided")
    }
    ...
    func testHistoryMergeRepairsAssistantSourceIdentityRotationAcrossToolRows() {
        ...
        let sourceKey = try! XCTUnwrap(
            CodexService.djlAssistantSourceItemKey(turnId: turnID, text: text)
        )
    ...
    func testDJLAssistantSourceItemKeyMatchesBridgeFormat() {
        XCTAssertEqual(
            CodexService.djlAssistantSourceItemKey(
                turnId: "turn-test",
                text: "  hello\n"
            ),
    ...
    func testSourceReplacementPrunesOnlyAbsentMirroredRowsInsideCanonicalTail() {
        ...
        var staleMirroredFinding = CodexMessage(id: "stale", threadId: threadID, role: .system, kind: .toolActivity, text: "stale finding", turnId: "turn-line-9", itemId: "djl-jsonl-tool-turn-line-9")
    ...
    func testSourceReplacementDoesNotUseRepeatedAssistantTextAsTailAnchor() {
        ...
        var laterMirror = CodexMessage(id: "later", threadId: threadID, role: .system, kind: .toolActivity, text: "keep until anchored", turnId: "turn-line-2", itemId: "djl-jsonl-tool-2")
    ...
    func testHistoryReconcileRefreshesStructuredPlanState() {
        ...
        let duplicate = CodexMessage(
            ...
            turnId: turnID,
            itemId: "djl-jsonl-progress-plan-\(turnID)",
            planState: CodexPlanState(
