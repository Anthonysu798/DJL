...
final class TurnViewModelQueueTests: XCTestCase {
    ...
    func testSendTurnQueuesImmediatelyWhenThreadBusy() async throws {
        ...
        viewModel.composerMentionedFiles = [
            TurnComposerMentionedFile(
                ...
                path: "DJL/Views/Turn/TurnView.swift"
            )
        ]
        ...
        XCTAssertEqual(queuedDraft.text, "Please inspect @DJL/Views/Turn/TurnView.swift")
    ...
    func testSendTurnStoresOnlyConfirmedFileMentionsOnUserMessage() async throws {
        ...
        XCTAssertEqual(message.text, "Please inspect @DJL/Views/Turn/TurnView.swift")
        XCTAssertEqual(message.fileMentions, ["DJL/Views/Turn/TurnView.swift"])
    }
    ...
    func testSendTurnDoesNotStoreManualFileLikeTextAsConfirmedMention() async throws {
        ...
        let viewModel = makeViewModel()
        viewModel.input = "Please inspect @DJL/Views/Turn/TurnView.swift"
    ...
    func testRestoreQueuedDraftMovesSelectedRowIntoComposerAndRemovesItFromQueue() {
        ...
        let second = QueuedTurnDraft(
            id: "draft-restore",
            text: "Please inspect @DJL/Views/Turn/TurnView.swift",
            attachments: [attachment],
            skillMentions: [
                CodexTurnSkillMention(
                    id: "check-code",
        ...
        XCTAssertEqual(viewModel.composerMentionedFiles.map(\.path), ["DJL/Views/Turn/TurnView.swift"])
    ...
    func testInterruptTurnFallsBackToThreadReadWhenFreshThreadTurnsListIsNotMaterialized() async throws {
        ...
        service.requestTransportOverride = { method, params in
            ...
            case "thread/turns/list":
                ...
                XCTAssertNil(params?.objectValue?["djlTurnStateOnly"])
