...
private extension CodexService {
    ...
    func extractAssistantEventIdentity(
        ...
        return AssistantEventIdentity(
            turnId: turnId,
            itemId: itemId,
            sourceItemKey: extractDJLSourceItemKey(
                paramsObject: paramsObject,
                eventObject: eventObject,
                itemObject: itemObject
            ),
    ...
    func extractDJLSourceItemKey(
        paramsObject: IncomingParamsObject,
        eventObject: IncomingParamsObject?,
        itemObject: IncomingParamsObject?
    ) -> String? {
        firstNonEmptyString([
            paramsObject["djlSourceItemKey"]?.stringValue,
            eventObject?["djlSourceItemKey"]?.stringValue,
            itemObject?["djlSourceItemKey"]?.stringValue,
            paramsObject["item"]?.objectValue?["djlSourceItemKey"]?.stringValue,
            eventObject?["item"]?.objectValue?["djlSourceItemKey"]?.stringValue,
        ])
    }
