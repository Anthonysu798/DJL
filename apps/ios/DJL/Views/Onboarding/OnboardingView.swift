...
struct OnboardingView: View {
    ...
    var body: some View {
            ...
            VStack(spacing: 0) {
                TabView(selection: $currentPage) {
                    ...
                    OnboardingStepPage(
                        ...
                        description: "The AI coding agent that lives in your terminal. DJL connects to it from your iPhone.",
        ...
        .alert("Install Codex CLI First", isPresented: $isShowingCodexInstallReminder) {
            ...
            Text("Copy and paste \"\(codexInstallCommand)\" on your device before moving on. DJL will not work until Codex CLI is installed and available in your PATH.")
        }
    }
