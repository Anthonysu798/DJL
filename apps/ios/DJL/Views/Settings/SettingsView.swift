...
struct SettingsView: View {
    ...
    @State private var isShowingAboutDJL = false
    ...
    var body: some View {
        ...
        .navigationDestination(isPresented: $isShowingAboutDJL) {
            AboutDJLView()
        }
    ...
    private func showAboutDJL() {
        isShowingAboutDJL = true
    }
...
private struct SettingsSecurityCard: View {
    ...
    var body: some View {
        SettingsCard(
            title: "Security",
            footer: "When enabled, DJL hides remote sessions in the app switcher and requires Face ID, Touch ID, or your device passcode after 5 minutes in the background."
        ) {
...
private struct SettingsNotificationsCard: View {
    ...
    var body: some View {
        SettingsCard(
            title: "Notifications",
            footer: "Alerts you when a run finishes while DJL is in the background."
        ) {
        ...
        SettingsCard(title: "Archived") {
            NavigationLink {
                ...
                SettingsLinkRow(
                    ...
                    DJLIcon.image(systemName: "archivebox")
                }
            }
        }
    }
