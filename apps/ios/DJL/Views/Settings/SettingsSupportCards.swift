    ...
    var body: some View {
        SettingsCard(
            ...
            Button {
                ...
                SettingsLinkRow(title: "How DJL Works") {
                    DJLIcon.image(systemName: "info.circle")
                }
            }
            ...
            Button {
                ...
                SettingsLinkRow(title: "Privacy Policy") {
                    DJLIcon.image(systemName: "hand.raised")
                }
            }
...
struct SettingsTrustedComputerCard: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 10) {
            HStack(spacing: 12) {
                DJLIcon.image(systemName: "laptopcomputer", size: 18, weight: .semibold)
                ...
                Button(action: onEditName) {
                    DJLIcon.image(systemName: "pencil")
