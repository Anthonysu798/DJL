...
private struct WorkspacePreviewChromeButton: View {
    ...
    var body: some View {
        Button {
            ...
            DJLIcon.image(systemName: systemName)
        ...
        HStack(spacing: 12) {
            ZStack {
                ...
                if isAutoLoadingPreview {
                    ...
                    DJLIcon.image(systemName: "photo")
            ...
            DJLIcon.image(systemName: "arrow.up.left.and.arrow.down.right")
        ...
        ZStack(alignment: .top) {
            ...
            VStack(spacing: 16) {
                ...
                if isLoading || errorMessage == nil {
                    ...
                    DJLIcon.image(systemName: "doc.text")
            ...
            .toolbar {
                ...
                ToolbarItemGroup(placement: .confirmationAction) {
                    Button {
                        ...
                        DJLIcon.image(systemName: "arrow.clockwise")
                    }
                    ...
                    Button {
                        ...
                        DJLIcon.image(systemName: isShowingCopiedConfirmation ? "checkmark" : "doc.on.doc")
                    }
...
private struct WorkspaceFileTypeIcon: View {
    ...
    var body: some View {
        ...
        ZStack {
            ...
            DJLIcon.image(systemName: style.symbolName)
                .font(AppFont.system(size: 17, weight: .semibold))
