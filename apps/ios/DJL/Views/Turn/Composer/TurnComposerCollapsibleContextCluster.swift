...
//             UIKitMenuButton, CodexWorktreeIcon, DJLIcon, AdaptiveGlassModifier
...
struct TurnComposerCollapsibleContextCluster: View {
    ...
    var body: some View {
        Button {
            ...
            // the chevron.
            DJLIcon.image(systemName: "chevron.right", size: toggleChevronSize)
...
struct TurnComposerContextClusterFloatingColumn: View {
    ...
    private var runtimeIconSystemName: String {
        ...
        return isWorktreeProject ? "djl.worktree" : "laptopcomputer"
    }
    ...
    private func buildRuntimeMenu() -> UIMenu {
        ...
        let localAction = UIAction(
            title: "Local",
            image: DJLIcon.menuUIImage(systemName: "laptopcomputer"),
            attributes: .disabled
        ) { _ in }
