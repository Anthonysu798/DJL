...
// Depends on: Foundation, UIKit, DJLIcon, SkillDisplayNameFormatter

import Foundation
import UIKit

nonisolated enum TurnComposerInlineSkillToken {
    static let attributeKey = NSAttributedString.Key("djl.inlineSkillToken")
    ...
    private static func tokenIcon(tintColor: UIColor) -> UIImage? {
        guard let base = DJLIcon.uiImage(systemName: "djl.skill") else { return nil }
        let side = tokenIconSide
