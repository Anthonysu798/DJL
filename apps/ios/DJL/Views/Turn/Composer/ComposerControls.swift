...
// Depends on: SwiftUI, DJLIcon, CircularIconBadge, TurnComposerRuntimeState
...
struct ComposerAttachmentMenu: View {
    ...
    var body: some View {
        Menu {
            // `DJLIcon.menuLabel` keeps Central artwork in SwiftUI Menus
            ...
            Toggle(isOn: Binding(
                ...
                DJLIcon.menuLabel("Plan mode", systemName: "djl.plan-mode")
            }
            ...
            Section {
                Button {
                    ...
                    DJLIcon.menuLabel("Photo library", systemName: "photo")
                }
                ...
                Button {
                    ...
                    DJLIcon.menuLabel("Take a photo", systemName: "camera.fill")
                }
                .disabled(remainingAttachmentSlots == 0)
            }
        } label: {
            DJLIcon.image(systemName: "plus")
