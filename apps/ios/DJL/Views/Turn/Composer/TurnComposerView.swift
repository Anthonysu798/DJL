...
struct TurnComposerView: View {
    ...
    private var composerStack: some View {
        VStack(spacing: 6) {
            ...
            // Keep the same page margins while the composer morphs between its
            // resting capsule and focused card. Changing this inset with focus
            // makes the whole surface appear to jump sideways as the keyboard opens.
    ...
    private var placeholderText: String {
        isEmptyThread ? "Ask DJL" : "Follow up"
    }
