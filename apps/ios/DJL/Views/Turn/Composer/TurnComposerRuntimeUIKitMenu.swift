...
enum TurnComposerRuntimeUIKitMenuBuilder {
    ...
    private static func modelMenu(_ input: Input) -> UIMenu {
        ...
        let modelChildren: [UIMenuElement] = {
            ...
            if hasOthers {
                items.append(
                    UIAction(
                        title: "Other models…",
                        image: DJLIcon.menuUIImage(systemName: "ellipsis")
                    ) { _ in
        ...
        return UIMenu(
            title: "Model",
            subtitle: subtitle,
            image: DJLIcon.menuUIImage(systemName: "cube"),
    ...
    private static func modelAction(model: CodexModelOption, input: Input) -> UIAction {
        ...
        let image: UIImage? = model.supportsServiceTier(.fast)
            ? DJLIcon.menuUIImage(systemName: CodexServiceTier.fast.iconName)
            : nil
    ...
    private static func speedMenu(_ input: Input) -> UIMenu? {
        ...
        let tierActions: [UIMenuElement] = CodexServiceTier.allCases.map { tier in
            UIAction(
                ...
                image: DJLIcon.menuUIImage(systemName: tier.iconName),
        ...
        return UIMenu(
            title: "Speed",
            subtitle: subtitle,
            image: DJLIcon.menuUIImage(systemName: "bolt.fill"),
            options: [.singleSelection],
