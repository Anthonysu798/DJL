...
struct TurnComposerRuntimeMenuBuilder {
    ...
    func makeRuntimeMenu() -> UIMenu? {
        ...
        return UIMenu(
            title: "Chat Runtime",
            image: DJLIcon.menuUIImage(systemName: "slider.horizontal.3"),
            children: children
        )
    }
    ...
    private func makeReasoningMenu() -> UIMenu? {
        ...
        return UIMenu(
            title: "Reasoning",
            image: DJLIcon.menuUIImage(systemName: "brain"),
            children: children
        )
    }
        ...
        children.append(
            contentsOf: CodexServiceTier.allCases.map { serviceTier in
                UIAction(
                    ...
                    image: DJLIcon.menuUIImage(systemName: serviceTier.iconName),
