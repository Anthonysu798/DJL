    ...
    func body(content: Content) -> some View {
        content
            ...
            .alert("Continue on Desktop App", isPresented: $isShowingMacHandoffConfirm) {
                ...
                Text("DJL will force close and reopen Codex.app on this device. Any desktop runs in progress will be stopped, and unsaved draft text there may be lost before this chat is opened.")
            }
            .alert(
