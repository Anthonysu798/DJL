...
// Exports: GhosttyTerminalSurface, DJLTerminalTheme
// Depends on: SwiftUI, GhosttyTerminalView

import Foundation
import SwiftUI

struct DJLTerminalTheme: Equatable {
    ...
    static func resolved(for colorScheme: ColorScheme) -> DJLTerminalTheme {
    ...
    static let light = DJLTerminalTheme(
        background: "#eff1f5",
        foreground: "#4c4f69",
    ...
    static let dark = DJLTerminalTheme(
        background: "#101113",
        foreground: "#d7d7dc",
