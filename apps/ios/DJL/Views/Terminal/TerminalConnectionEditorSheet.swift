...
// Depends on: SwiftUI, UIKit, DJLTerminalModels, DJLTerminalPrivateKeyStore
...
struct TerminalConnectionEditorSheet: View {
    ...
    @Binding var profile: DJLTerminalProfile
    ...
    private var keyLabel: String {
        DJLTerminalPrivateKeyStore.hasPrivateKey(privateKey) ? "Imported" : "Import"
    }
            ...
            .toolbar {
                ...
                ToolbarItemGroup(placement: .topBarTrailing) {
                    Button {
                        ...
                        DJLIcon.image(systemName: "questionmark.circle")
    ...
    var body: some View {
        TerminalEditorSection(title: "Authentication") {
            VStack(spacing: 0) {
                ...
                if isShowingKeyEditor || !DJLTerminalPrivateKeyStore.hasPrivateKey(privateKey) {
