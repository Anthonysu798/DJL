...
final class GhosttyTerminalView: UIView, UITextFieldDelegate, UIGestureRecognizerDelegate, UIEditMenuInteractionDelegate {
    ...
    var terminalKey: String = "" {
        didSet {
            accessibilityIdentifier = "djl-terminal-\(terminalKey)"
        }
    }
    ...
    func editMenuInteraction(
        ...
        let copyAction = UIAction(title: "Copy", image: DJLIcon.menuUIImage(systemName: "doc.on.doc")) { [weak self] _ in
    ...
    private func writeThemeConfigFile() -> String? {
        ...
        let url = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("djl-terminal-theme-\(appearance.rawValue).ghostty")
