...
// Depends on: SwiftUI, UIKit, DJLTerminalPrivateKeyStore
...
struct TerminalPrivateKeyEditor: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            if isShowingKey || !DJLTerminalPrivateKeyStore.hasPrivateKey(privateKey) {
...
private struct TerminalPrivateKeySavedRow: View {
    var body: some View {
        HStack(spacing: 8) {
            DJLIcon.image(systemName: "checkmark.seal.fill")
