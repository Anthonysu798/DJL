// FILE: DJLIcon.swift
// Purpose: Resolves DJL-specific icons to bundled Central custom assets with SF Symbol fallback.
// Layer: View Utility
// Exports: DJLIcon
...
enum DJLIcon {
    private static let customAssetsBySystemName: [String: String] = [
        ...
        "djl.agent": "central-robot",
        "djl.auto-review": "central-shield-check-3",
        "djl.branch": "central-branch",
        "djl.changes": "changes",
        "djl.plan-mode": "central-planning",
        "djl.skill": "central-building-blocks",
        "djl.worktree": "central-arrow-split-right",
        "server.rack": "central-server",
        "shift": "central-shift",
        "slider.horizontal.3": "central-settings-slider-three",
        "speedometer": "central-dashboard-fast",
        "djl.fork": "central-fork-code",
        // Real GitHub octocat mark (template-tinted) for GitHub-specific tool rows.
        "djl.github": "GitHub_Invertocat_Black",
        "djl.git-branch": "git-branch",
        "djl.goal": "central-target-arrow",
...
private let djlIconSquareAnchorSymbol = "square"

private struct DJLIconView: View {
    ...
    var body: some View {
        if let assetName = DJLIcon.assetName(for: systemName) {
    ...
    private func customAsset(_ assetName: String) -> some View {
        ...
        if explicitSize != nil {
            ...
            Image(systemName: djlIconSquareAnchorSymbol)
                .opacity(0)
