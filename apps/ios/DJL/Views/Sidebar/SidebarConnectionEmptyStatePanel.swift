...
struct SidebarConnectionEmptyStatePanel: View {
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            // This panel is only rendered for an offline, unpaired sidebar.
            // Keep the secure manual-code path visible alongside QR pairing so
            // a camera-less Simulator can still complete authenticated pairing.
            pairWithCodeButton
    ...
    private var heroIcon: some View {
        ZStack {
            ...
            DJLIcon.image(systemName: heroIconName, size: 28, weight: .regular)
    ...
    private var primaryButton: some View {
        ...
        .accessibilityIdentifier("connection-primary-action")
    }
    ...
    private var pairWithCodeButton: some View {
        secondaryButton("Pair with Code", systemName: "keyboard", action: onPairWithCode)
            ...
            .accessibilityLabel(Text("Pair with Code"))
            .accessibilityIdentifier("connection-pair-with-code")
    }
