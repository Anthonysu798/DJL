...
//             SidebarSectionExpansionChevron, SidebarThreadGroup, DJLIcon,
...
struct SidebarProjectSectionHeader: View {
    ...
    private var leadingIcon: some View {
        if group.iconSystemName == "djl.worktree" {
            ...
            DJLIcon.image(systemName: resolvedIconName)
    ...
    private var composeButton: some View {
        ...
        HapticButton(hapticStyle: .medium, action: onCreate) {
            DJLIcon.image(systemName: "square.and.pencil", size: 18, weight: .medium)
        ...
        if let onArchive {
            children.append(
                UIAction(
                    ...
                    image: DJLIcon.menuUIImage(systemName: "archivebox")
                ) { _ in
        ...
        if let onDelete {
            children.append(
                UIAction(
                    ...
                    image: DJLIcon.menuUIImage(systemName: "trash"),
