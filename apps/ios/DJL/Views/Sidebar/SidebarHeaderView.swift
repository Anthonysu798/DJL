...
// Depends on: SwiftUI, UIKit, SidebarToolbarIconButton, DJLIcon,
...
struct SidebarHeaderView: View {
    ...
    private var overflowMenuButton: some View {
        ...
        // through `DJLIcon.menuUIImage` at the SF Symbol menu glyph
    ...
    private func overflowAction(
        ...
        UIAction(
            title: title,
            image: DJLIcon.menuUIImage(systemName: systemName),
