    ...
    private var expansionToggleButton: some View {
        if childSubagentCount > 0, let onToggleSubagents {
            HapticButton(action: onToggleSubagents) {
                DJLIcon.image(systemName: isSubagentExpanded ? "chevron.down" : "chevron.right")
...
private enum SidebarRowPreviewFixtures {
    ...
    static let allThreads: [CodexThread] = [
        ...
        // ── Project 2: payments ──
        CodexThread(id: "p3", title: "Fix payment flow", createdAt: now.addingTimeInterval(-14400), updatedAt: now.addingTimeInterval(-1200), cwd: "/Users/dev/payments"),
        CodexThread(id: "p3_a", title: "Ford [planner]", createdAt: now.addingTimeInterval(-13000), updatedAt: now.addingTimeInterval(-1500), cwd: "/Users/dev/payments", parentThreadId: "p3", agentNickname: "Ford", agentRole: "planner"),
