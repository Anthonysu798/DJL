...
// Layer: App
// Exports: DJLAppDelegate, Notification.Name push-registration helpers
...
final class DJLAppDelegate: NSObject, UIApplicationDelegate {
    func application(
        ...
        configuration.delegateClass = DJLSceneDelegate.self
    ...
    func application(
        ...
        if let shortcutItem = launchOptions?[.shortcutItem] as? UIApplicationShortcutItem {
            Task { @MainActor in
                DJLQuickActionCenter.handleShortcutItem(shortcutItem)
            }
        }
    ...
    func application(
        ...
        Task { @MainActor in
            completionHandler(DJLQuickActionCenter.handleShortcutItem(shortcutItem))
        }
    }
...
final class DJLSceneDelegate: NSObject, UIWindowSceneDelegate {
    func scene(
        _ scene: UIScene,
