...
struct CodexThread: Identifiable, Codable, Hashable, Sendable {
    ...
    init(
        ...
        self.runtimeMode = Self.normalizeIdentifier(runtimeMode)
    ...
    init(from decoder: Decoder) throws {
        ...
        runtimeMode = Self.decodeIdentifierIfPresent(from: container, keys: [.runtimeMode, .runtimeModeSnake])
    ...
    func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(Self.normalizeIdentifier(runtimeMode), forKey: .runtimeMode)
...
extension CodexThread {
    ...
    var isManagedWorktreeProject: Bool {
        Self.projectIconSystemName(for: normalizedProjectPath) == "djl.worktree"
    }
    ...
    static func projectIconSystemName(for normalizedProjectPath: String?) -> String {
        ...
        return codexManagedWorktreeToken(for: normalizedProjectPath) == nil ? "folder" : "djl.worktree"
    }
