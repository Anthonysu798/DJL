...
export interface OrchestrationEngineShape {
  ...
  /**
   * Replay persisted events after a cursor, then continue with the hot stream.
   * The live subscription is acquired before replay begins and duplicate or
   * out-of-order sequence numbers are suppressed at the handoff boundary.
   */
  readonly streamDomainEventsFrom: (
    fromSequenceExclusive: number,
  ) => Stream.Stream<OrchestrationEvent, OrchestrationEventStoreError, never>;
