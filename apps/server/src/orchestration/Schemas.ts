import {
  ...
  ThreadWorkTaskTransitionedPayload as ContractsThreadWorkTaskTransitionedPayloadSchema,
...
export const ThreadWorkTaskTransitionedPayload = ContractsThreadWorkTaskTransitionedPayloadSchema;
