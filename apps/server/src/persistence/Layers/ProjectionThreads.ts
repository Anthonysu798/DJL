...
const ProjectionThreadDbRow = ProjectionThread.mapFields(
  Struct.assign({
    ...
    workTask: Schema.optional(Schema.NullOr(Schema.fromJsonString(WorkTask))),
  }),
);
    ...
    execute: (row) =>
      sql`
        ...
        VALUES (
          ...
          ${row.latestTurnId},
          ${row.workTask == null ? null : JSON.stringify(row.workTask)},
        ...
        DO UPDATE SET
          ...
          work_task_json = excluded.work_task_json,
