...
import { MemoryReactor } from "../src/orchestration/Services/MemoryReactor.ts";
import { ProjectionSnapshotQuery } from "../src/orchestration/Services/ProjectionSnapshotQuery.ts";
import {
  RuntimeReceiptBus,
  type OrchestrationRuntimeReceipt,
} from "../src/orchestration/Services/RuntimeReceiptBus.ts";
import { WorkPreparationQueue } from "../src/orchestration/Services/WorkPreparationQueue.ts";
...
export const makeOrchestrationIntegrationHarness = (
  ...
  Effect.gen(function* () {
    ...
    const workPreparationQueueLayer = Layer.succeed(WorkPreparationQueue, {
      start: Effect.void,
      enqueue: () => Effect.void,
    ...
    const memoryReactorLayer = Layer.succeed(MemoryReactor, {
      start: Effect.void,
      drain: Effect.void,
    });
