...
// The fixed h-[100vh] is also dropped so this can layer inside a section rather than fill the
// screen, and children are optional so it can serve as a pure background element.
...
const AURORA_VARS = {
  // Upstream's blue/indigo/violet ribbon — the light-canvas look from ui.aceternity.com.
  "--aurora":
