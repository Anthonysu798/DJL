...
export function GLM52Rise() {
  ...
  const p = interpolate(frame, [32, 150], [0, 1], {
      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            ...
            <div style={{ fontSize: 20, fontWeight: 500, color: c.faint, letterSpacing: 1 }}>
              JUN 12–25, 2026
            </div>
          </div>
          ...
          <div style={{ marginTop: 52 }}>
            ...
            <div style={{ marginTop: 22, fontSize: 30, fontWeight: 500, color: c.muted }}>
              From 0 to <span style={{ color: c.ink }}>{tokensT.toFixed(2)}T tokens</span> in a
              week.
            </div>
          </div>
                      ...
                      >
                        {field.map((seg) => (
                          <div
                            ...
                            style={{
                              height: Math.round(
                                ((d[seg.key as keyof typeof d] as number) / fieldTotal) * fieldH,
                              ),
          ...
          >
            <div style={{ display: "inline-flex", alignItems: "center", gap: 9, color: c.muted }}>
              <span
                style={{ width: 13, height: 13, background: c.accent, display: "inline-block" }}
              />
              GLM-5.2
            </div>
