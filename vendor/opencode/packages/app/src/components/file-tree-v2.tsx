...
export default function FileTreeV2(props: {
  ...
  const rows = createMemo(() =>
    flattenFileTreeV2(model(), (path) => file.tree.state(path)?.expanded ?? true),
  );
  ...
  createEffect(() => {
    ...
    queueMicrotask(() => {
      if (
        virtualizer.range &&
        index >= virtualizer.range.startIndex &&
        index <= virtualizer.range.endIndex
      )
        return;
                    ...
                    >
                      ...
                      >
                        ...
                        <div
                          ...
                          data-expanded={
                            file.tree.state(row().node.path)?.expanded === false ? undefined : ""
                          }
