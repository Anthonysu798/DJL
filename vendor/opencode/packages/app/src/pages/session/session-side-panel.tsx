...
import {
  ...
  type SessionFileBrowserState,
} from "@/pages/session/v2/session-file-browser-tab";
                        ...
                        >
                          <Show when={reviewTab() && props.canReview()}>
                            <Tabs.Trigger
                              ...
                              id={reviewTabID}
                              aria-controls={
                                activeTab() === "review" ? reviewTabPanelID : undefined
                              }
                            >
                                ...
                                <Show
                                  ...
                                  fallback={
                                    <SortableTab
                                      ...
                                      onTabDoubleClick={
                                        temporaryTab() === tab ? openTab : undefined
                                      }
                                    />
                                  }
                                >
